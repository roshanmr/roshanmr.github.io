...
<body class="inner-page drupal-page">
  <div class="canvas">
    ...
    <header class="section-page-header">
      ...
      <div class="page-wrap">
        <h1 class="text-rotator"><span class="text-rotate">Passionate engineering teams , Mature Agile processes, Flexible staffing models </span>Asia's Largest Drupal Company</h1>
      </div>
    </header>
