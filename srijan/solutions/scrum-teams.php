...
<head>
    ...
    <title>Srijan | Solutions | Performance Audit</title>
...
<body class="inner-page">
        ...
        <div class="ps-wrap row">
          ...
          <article class="ps-main col-9">
            <section class="article-subsection" id="empoweredTeams">
              ...
              <div class="pdf-download-large row">
                <figure class="col-4">
                  <img src="/img/flyer.jpg" alt="">
                </figure>
                <div class="download-text col-8">
                  <h3>Can a Drupal website or application perform better than it does right now?</h3>
                  <p>Srijan’s Drupal Audit service identifies bottlenecks and problems, risks and vulnerabilities, and provides recommendations on resolving them. Download a comprehensive document to understand how our Security and Performance Audit process works </p>
                  ...
                  <div class="confirm-txt">
                    <p>Thank you for downloading! Your download will start in <span>3</span> seconds</p>
                  </div>   
                </div>
    ...
    <section class="guttered case-study inner-case-study">
                ...
                <article class="col-4">
                  <a href="#">
                    <div class="cs-col-wrap">
                      ...
                      <span class="logo">
                        <svg version="1.1" class="cs-logo" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 100" xml:space="preserve">
                        <g>
                          <path id="path3009" d="M72.3,34.6v31.4h11.2V54.9h4.7c4.8,0,13-1.8,13-10.6c0-4.4-3.5-9.7-10.8-9.7L72.3,34.6z M83.3,40.5h3.8
                          c2.3,0,3.7,2.2,3.7,4.2c0,2.3-1.7,4.1-3.6,4.1h-3.9V40.5z"></path>
                          <path id="path3782" d="M102.8,66.1V34.6h25v6.7h-13.8v5.5h12.6v6.7h-12.6v5.9h13.9v6.6H102.8z"></path>
                          <path id="path3784" d="M132.6,66.1V34.6h9.4l13.3,15.8l0.1-15.8h9.5v31.5h-8.7l-13.1-16v16H132.6z"></path>
                          ...
                          C46.2,45.5,48.6,42.8,52,42.8z"></path>
                        </g>
                      </svg>
                    </span>
                ...
                <a href="#">
                  <div class="cs-col-wrap">
                    ...
                    <span class="logo">
                      ...
                      <svg version="1.1" class="cs-logo" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 100" style="enable-background:new 0 0 200 100;" xml:space="preserve">
                      ...
                      c-0.8,1.2-1.5,2.4-2.2,3.5c1.6,1.7,3.2,3.3,4.7,5c4.1-2.6,8.1-5.1,12.2-7.7C49.5,43.6,48.8,42.4,48.1,41.1z"></path>
                      <path d="M76.5,35.1c0,0.3,0,0.5,0,0.8c0,7.2,0,14.4,0,21.6c0,0.3,0,0.6,0,1c-1.2,0-2.4,0-3.6,0c-0.1,0-0.3-0.2-0.3-0.4
                      c-0.1-0.2,0-0.4,0-0.6c0-7.2,0-14.4,0-21.6c0-0.3,0-0.6,0-0.9C73.9,35.1,75.2,35.1,76.5,35.1z"></path>
                      ...
                      C158.1,49.1,158.1,49.9,158.1,50.7z"></path>
                      ...
                      c0.1,0.9,0.5,1.5,1.4,1.8c1.6,0.6,3.8-0.4,4.2-2.1C105.4,52.9,105.3,51.8,105.4,50.7z"></path>
                      ...
                      c0-1.4-0.4-2.7-1.6-3.5c-1.2-0.8-2.5-0.7-3.7,0c-1.2,0.8-1.7,2-1.9,3.4C85.6,48.8,87.9,48.8,90.3,48.8z"></path>
                      ...
                      c-1,0-2,0-3,0c-0.7,0-0.9,0.2-0.9,0.9c0.1,2.4,0,4.8,0.1,7.2c0.1,1.6,0.8,2.1,2.4,2.1C132.1,55.6,132.4,55.6,132.9,55.6z"></path>
                      ...
                      c-2.7-0.7-5.3-1-7.1,1.6c-1.3,1.8-1.2,4.7,0.1,6.4C64.3,56.3,66.8,56,69.6,55.2z"></path>
                      ...
                      c-0.6,0-0.8-0.2-0.8-0.8c0-3.8,0-7.6,0-11.3C112.8,45.2,112.8,43.9,112.8,42.6z"></path>
                      ...
                      c0-3.9,0-7.8,0-11.8C135.5,44.9,135.5,43.8,135.5,42.6z"></path>
                      <path d="M146.5,42.6c1.3,0,2.5,0,3.8,0c0,0.2,0,0.5,0,0.7c0,4.8,0,9.6,0,14.5c0,0.6-0.2,0.8-0.8,0.8c-0.9,0-1.7,0-2.6,0
                      c-0.4,0-0.6-0.1-0.6-0.5c0-5,0-10.1,0-15.1C146.5,42.8,146.5,42.7,146.5,42.6z"></path>
                      <path d="M146.2,38c0-1.3,1-2.2,2.3-2.1c1.2,0,2.2,0.9,2.2,2.2c0,1.2-1,2.2-2.3,2.2C147.1,40.1,146.2,39.2,146.2,38z"></path>
                    </svg>
              ...
              <a href="#">
                <div class="cs-col-wrap">
                  ...
                  <span class="logo">
                    ...
                    <svg version="1.1" id="Layer_1" class="cs-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 200 100" xml:space="preserve">
                    <g>
                      ...
                      c1.4-3,2.7-6.1,3.3-9.4C94.3,48.5,93.5,47.4,91,46.7z"></path>
                      ...
                      C161.7,72.1,161.5,70.9,161.5,69.5z"></path>
                      ...
                      c0-5.8,0-11.5,0-17.3c0-0.3,0-0.6,0-1c1.4-0.1,2.8-0.2,4.1-0.3c0.7-0.1,1.5-0.2,2-0.8C137.5,53.5,136.9,50.3,135.6,49.6z"></path>
                      ...
                      C175.1,66.8,175.1,59.4,175.1,52z"></path>
                      <path d="M96.3,19c-3.8,0-6.9,3-6.9,6.9c0,3.8,3.1,6.8,6.9,6.8c3.8,0,6.8-3.1,6.8-6.9C103.2,22,100.1,19,96.3,19z"></path>
                    </g>
                  </svg>
