        ...
        <div class="cs-wrapper">
          <div class="tag-filter">
            ...
            <ul class="tag-list">
              ...
              <li><a href="filter.php">Business Services</a></li>
              <li><a href="filter.php">Community</a></li>
              <li><a href="filter.php">Customer Services</a></li>
              <li><a href="filter.php">Education</a></li>
              <li><a href="filter.php">Finance</a></li>
              <li><a href="filter.php">Government</a></li>
              <li><a href="filter.php">Healthcare</a></li>
              <li><a href="filter.php">Hospitality</a></li>
              <li><a href="filter.php">Information Technology</a></li>
              <li><a href="filter.php">Legal</a></li>
              <li><a href="filter.php">Media &amp; Entertainment</a></li>
              <li><a href="filter.php">Non-profit</a></li>
              <li><a href="filter.php">Retail</a></li>
              <li><a href="filter.php">Telecommunications</a></li>
              <li><a href="filter.php">Travel</a></li>
            </ul>
          </div>
          <div class="row">
            <article class="col-4">
...
<section class="client-logo-list">
  ...
  <div class="page-wrap">
    <ul class="logo-listing">
      <li>
        <a href="#">
          <img src="../img/clients/agentur.jpg" alt="logo">
        </a>
      </li>
      <li>
        <a href="#">
          <img src="../img/clients/akdn.jpg" alt="logo">
        </a>
      </li>
      <li>
        <a href="#">
          <img src="../img/clients/alfaisal.jpg" alt="logo">
        </a>
      </li>
      <li>
        <a href="#">
          <img src="../img/clients/ashoka.gif" alt="logo">
        </a>
      </li>

      <li>
        <a href="#">
          <img src="../img/clients/askme.png" alt="logo">
        </a>
      </li>

      <li>
        <a href="#">
          <img src="../img/clients/autox.png" alt="logo">
        </a>
      </li>

      <li>
        <a href="#">
          <img src="../img/clients/avtranz.jpg" alt="logo">
        </a>
      </li>
