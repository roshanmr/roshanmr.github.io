        ...
        <div class="ps-wrap row">
          ...
          <article class="ps-main col-9">
            ...
            <nav class="pagination-nav">
              ...
              <a href="software-prototyping.php" class="next"><strong>Next:</strong> Software Prototyping <span class="s-icon"> <i class="fa fa-chevron-circle-right"></i></span></a>
            </nav>


            <nav class="pagination-nav fixed-page-nav">
              <a href="solutions.php" class="previous"> <span class="s-icon"><i class="fa fa-chevron-circle-left"></i> </span> <strong>Previous:</strong> Empowered Teams</a>
              <a href="software-prototyping.php" class="next"><strong>Next:</strong>Software Prototyping <span class="s-icon"> <i class="fa fa-chevron-circle-right"></i></span></a>
            </nav>
