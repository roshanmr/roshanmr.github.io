        ...
        <div class="ps-wrap row">
          ...
          <article class="ps-main col-9">
            <section class="article-subsection show" id="empoweredTeams">
              <h1>Solutions &amp; Products designed to deliver business outcomes</h1>
              <header class="sub-header">
                <?php echo file_get_contents("img/team.svg"); ?>
              </header>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer et laoreet metus. Sed dolor velit, fringilla sed diam eget, bibendum aliquet tellus. Sed id auctor odio. Nullam sit amet facilisis tortor. Nullam dapibus vulputate mauris sed malesuada. Aenean dolor ligula, faucibus vel lobortis nec, malesuada nec urna. Vivamus purus ex, iaculis in bibendum ac, egestas sit amet magna. Morbi eget erat id nisl tempor facilisis efficitur ut ligula. Duis consequat purus urna. </p>
