		...
		<section class="contact-page">
			<div class="page-wrap">
				...
				<div class="row location">
					<div class="col-4 map">
						<img src="/img/indiamap.png">
						<ul>
							<li id="delhi-mark" class="map-active"><span class="marker"></span></li>
							<li id="bangalore-mark"><span class="marker"></span></li>
							<li id="goa-mark"><span class="marker"></span></li>
						</ul>
					</div>
				...
				<div class="row location">
					<div class="col-4 map">
						<img src="/img/americamap.png">
						<ul>
							<li id="san-francisco-mark" class="map-active"><span class="marker"></span></li>
						</ul>
					</div>
					<div class="side-tabs tab-container col-8 row address">
						<div class="tab-links col-4">
				...
				<div class="row location">
					<div class="col-4 map">
						<img src="/img/eastasiamap.png">
						<ul>
							<li id="australia-mark" class="map-active"><span class="marker"></span></li>
							<li id="singapore-mark"><span class="marker"></span></li>
						</ul>
					</div>
					<div class="side-tabs tab-container col-8 row address">
						<div class="tab-links col-4">
