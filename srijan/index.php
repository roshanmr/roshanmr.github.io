                    ...
                    <div class="col-4-half">
                      ...
                      <article class="case-study-item">
                        ...
                        <div class="cs-text">
                          ...
                          <p>
                            Drupal website development with upgraded UX and multiple functionalities and integrations improves customer experience and simplifies lead capturing
                          </p>
                ...
                <div class="row">
                        ...
                        <div class="row">
                          <div class="col-3">
                            ...
                            <ul class="menu">
                             ...
                             <li><a href="#nogo">Process <i class="fa fa-angle-down"></i></a>
                              <div class="fat-nav">
                              ...
                              <ul class="related-links">
                                ...
                                <li><a href="#">
                                  <div class="box">
                                    ...
                                    <h3>
                                      <span>Thought Article</span>Srijan Opens its First Office in Singapore
                                    </h3>
                                  </div>
                                </a></li>
                              </ul>
                              ...
                              <ul class="related-links">
                                <li><a href="#">
                                  <div class="box">
                                    ...
                                    <h3>
                                      <span>Success Stories</span>Engagement Driven and Scalable Website for AskMe Fashion
                                    </h3>
                                  </div>
                                </a></li>
                                <li><a href="#">
                                  <div class="box">
                                    ...
                                    <h3>
                                      <span>Thought Article</span>Microservice Architecture is Not for You
                                    </h3>
                                  </div>
                                </a></li>
                              </ul>
                  ...
                  <section class="content-block process-bg">
                    ...
                    <div class="page-wrap row process-wrap">
                      <div class="process-item col-3 orange">
                        <div class="item-wrap">
                          <a href="#">
                            <header>
                              <span class="icon">
                                <?php echo file_get_contents("img/discovery.svg"); ?>
                              </span><h2>
                              Discovery</h2>
                            </header>
                            <div class="intro-txt">
                      ...
                      <div class="process-item col-3 blue">
                        <div class="item-wrap">
                          <a href="#">
                            <header>
                              <span class="icon">
                            ...
                            <ul class="action-menu">
                              <li><a href="#">Scrum Teams <i class="fa fa-angle-right"></i></a></li>
                              <li><a href="#">Agile &amp; JIRA <i class="fa fa-angle-right"></i></a></li>
                            </ul>
                          </div>
                        </div>
                        <div class="process-item col-3 turquoise">
                          <div class="item-wrap">
                            <a href="#">
                              <header>
                                <span class="icon">
